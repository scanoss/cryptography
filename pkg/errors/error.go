...
// TODO: Move this module to github.com/scanoss/go-grpc-helper
...
type ServiceError struct {
	...
	InternalCode common.StatusCode      // Internal error code for logging/monitoring
...
func NewBadRequestError(message string, err error) *ServiceError {
	return &ServiceError{
		...
		InternalCode: common.StatusCode_FAILED,
		Err:          err,
	}
}
...
func HandleServiceError(ctx context.Context, s *zap.SugaredLogger, err error) *common.StatusResponse {
	...
	if IsServiceError(err) {
		...
		return &common.StatusResponse{
			Status:  serviceErr.InternalCode,
