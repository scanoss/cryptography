...
func LoadTestSQLData(db *sqlx.DB, ctx context.Context, conn *sqlx.Conn) error {
	files := []string{"../models/tests/mines.sql", "../models/tests/all_urls.sql", "../models/tests/versions.sql", "../models/tests/component_crypto.sql", "../models/tests/components_crypto_library.sql", "../models/tests/crypto_library.sql"}
